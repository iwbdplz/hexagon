...
<form action="create.do" method="post">
	...
	<tr>
		<td>
			携帯番号:<input type="text" name="phoneNum">
			<c:if test="${errors.phoneNum}"><br>携帯番号を入力してください。</c:if>
		</td>
		<td>
			部署:<input type="text" name="dept">
	...
	<tr>
		<td>
			職位:<input type="text" name="position">
			<c:if test="${errors.position}"><br>職位を入力してください。</c:if>
		</td>
		<td>
			入社日:<input type="date" name="hiredAt">
	...
	<tr>
		<td>
			使用銀行:<input type="text" name="financialCo">
			<c:if test="${errors.financialCo}"><br>使用銀行を入力してください。</c:if>
		</td>
		<td>
			口座番号:<input type="text" name="accountNum">
